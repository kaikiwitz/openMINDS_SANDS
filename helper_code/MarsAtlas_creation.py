...
if __name__ == '__main__':
    ...
    mars_authors_unique, full_documentation, main_documentation, description, abbreviation, fullName, shortName, \
        homepage, versions, areas_versions_hierachry, areas_unique, parents_unique = MarsAtlas_data.data_structures()
    # helper vars
    j = ".jsonld"
    ...
    # function calling
    generate_persons(person_dir, mars_authors_unique)
    generate_dois(doi_dir, full_documentation)
    generate_orcids(orcid_dir, mars_authors_unique)
    generate_atlas(atlas_dir, mars_authors_unique,
                   versions, description, shortName, fullName, homepage, main_documentation, abbreviation, areas_unique,
                   parents_unique)
