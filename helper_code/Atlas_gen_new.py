...
if __name__ == "__main__":
    ...
    Atlas_handler.call_methods(Atlas.generate_instances, Atlas.generate_openminds_instances)
    Parcellations_handler.call_methods(Parcellations.generate_instances)
    ...
    for dic in versions:
        for version in dic.keys():
            ...
            AtlasVersion_handler.call_methods(AtlasVersion.generate_instances)
            ParcellationEntityVersion_handler.call_methods(ParcellationEntityVersion.generate_instances)
